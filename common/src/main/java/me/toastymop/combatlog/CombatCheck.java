...
public class CombatCheck {
    ...
    public static void setCombat(PlayerEntity target, PlayerEntity attacker ){
        ...
        if (CombatConfig.Config.disablePearl){
            target.getItemCooldownManager().set(Items.ENDER_PEARL.getDefaultStack().getItem(),CombatConfig.Config.combatTime * 20);
            attacker.getItemCooldownManager().set(Items.ENDER_PEARL.getDefaultStack().getItem(),CombatConfig.Config.combatTime * 20);
        }
    }
